...
func TestRun(t *testing.T) {
	...
	if !reflect.DeepEqual(expectedLog, log) {
...
func TestRun_InitError(t *testing.T) {
	...
	game := &MockGame{}
	term := &MockTerm{
		InitFn: func() error { return expectedErr },
	}
	if err := Run(game, WithTerm(term)); err != expectedErr {
...
func TestRun_FlushError(t *testing.T) {
	...
	term := &MockTerm{
		...
		ClearFn: func() {},
		FlushFn: func() error { return expectedErr },
	}
	if err := Run(game, WithTerm(term)); err != expectedErr {
...
func TestRun_UpdateError(t *testing.T) {
	...
	game := &MockGame{
		UpdateFn: func([]Key) error { return expectedErr },
	}
	term := &MockTerm{
		InitFn:  func() error { return expectedErr },
		InputFn: func() chan Key { return nil },
